...
import { Breadcrumb, BreadcrumbItem, Form, Button, ButtonGroup, FormGroup, Label, Input, Col, Row, FormFeedback} from 'reactstrap';
...
class Contact extends Component {
    ...
    validate(firstname, lastname, telnum, email, message) {
        ...
        const reg = /^\d+$/; // all characters should be numbers regular expressions
